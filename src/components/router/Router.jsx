...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        loader: ({ params }) =>
          fetch(
            `https://serversite-pet-adoption.vercel.app/petbycategory/${params.cat}`
          ),
      },
      {
        path: "/adoptionreq",
        element: (
          <PrivateRoute>
            <AdoptionReqDashboard></AdoptionReqDashboard>
          </PrivateRoute>
        ),
      },
      {
      ...
      },
      {
        ...
        element: (
          <PrivateRoute>
            <DonationCampaignDetails></DonationCampaignDetails>
          </PrivateRoute>
        ),
        loader: ({ params }) =>
          fetch(
            `https://serversite-pet-adoption.vercel.app/adddonationcamp/${params.id}`
          ),
      },
      {
        path: "/login",
      ...
      },
      {
        ...
        element: (
          <PrivateRoute>
            <AddPetDashboard></AddPetDashboard>
          </PrivateRoute>
        ),
      },
      {
      ...
      },
      {
        ...
        element: (
          <PrivateRoute>
            <MyAddedPetsDashboard></MyAddedPetsDashboard>
          </PrivateRoute>
        ),
      },
      {
        ...
        element: (
          <PrivateRoute>
            <CreateDonationCampaignDashboard></CreateDonationCampaignDashboard>
          </PrivateRoute>
        ),
      },
      {
        ...
        element: (
          <PrivateRoute>
            {" "}
            <MyDonationDashboard></MyDonationDashboard>
          </PrivateRoute>
        ),
      },
      {
        ...
        element: (
          <PrivateRoute>
            <UpdateDonationCampDashboard></UpdateDonationCampDashboard>
          </PrivateRoute>
        ),
        loader: ({ params }) =>
          fetch(
            `https://serversite-pet-adoption.vercel.app/adddonationcamp/${params.donationCampaignId}`
          ),
      },

      {
        ...
        element: (
          <PrivateRoute>
            <UpdatePetDashboard></UpdatePetDashboard>
          </PrivateRoute>
        ),
        loader: ({ params }) =>
          fetch(
            `https://serversite-pet-adoption.vercel.app/pets/${params.petId}`
          ),
      },
      {
        path: "/mydonationcamp",
        element: (
          <PrivateRoute>
            <MyDonationCampDashboard></MyDonationCampDashboard>
          </PrivateRoute>
        ),
      },
      {
      ...
      },
      {
        ...
        element: (
          <PrivateRoute>
            <AllPetsAdminDashboard></AllPetsAdminDashboard>
          </PrivateRoute>
        ),
      },

      {
        ...
        element: (
          <PrivateRoute>
            <AllDonationCampAdminDashboard></AllDonationCampAdminDashboard>
          </PrivateRoute>
        ),
      },
    ],
